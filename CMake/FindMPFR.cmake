# Adapted from CGAL http://www.cgal.org
# https://github.com/CGAL/cgal/blob/master/Installation/cmake/modules/FindMPFR.cmake
...
if (MPFR_in_cache)
  ...
  if ( MPFR_INCLUDE_DIR STREQUAL "$ENV{CGAL_DIR}/auxiliary/gmp/include" )
  ...
  find_library(MPFR_LIBRARIES NAMES mpfr libmpfr-4 libmpfr-1
    HINTS ENV MPFR_LIB_DIR
          ENV MPFR_DIR
          $ENV{CGAL_DIR}auxiliary/gmp/lib
    PATH_SUFFIXES lib
